...
- `.gemini/rules/react.mdc` : React関連の指示
- `.gemini/rules/storybook.mdc` : Storybook関連の指示
- `.gemini/rules/test.mdc` : テスト関連の指示
- `.gemini/rules/docs.mdc` : 設計書関連の指示
- `.gemini/rules/general.mdc` : その他
