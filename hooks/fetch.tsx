...
export const fetchHistories = async (): Promise<ResponseHistory> => {
  ...
  if (!response.ok) {
    ...
    console.error(
      `Failed to fetch histories: ${response.status} - ${errorText}`
    );
...
export const fetchHistory = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch history ${id}: ${response.status} - ${errorText}`
    );
...
export const fetchJob = async (id: string): Promise<ResponseJobDetail> => {
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch job ${id}: ${response.status} - ${errorText}`
    );
...
export const fetchLicenses = async (): Promise<ResponseLicense> => {
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch licenses: ${response.status} - ${errorText}`
    );
...
export const fetchLicense = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch license ${id}: ${response.status} - ${errorText}`
    );
...
export const fetchPortfoliosFront = async (): Promise<ResponsePortfolios> => {
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch portfolios (front): ${response.status} - ${errorText}`
    );
...
export const fetchPortfolios = async (): Promise<ResponsePortfolios> => {
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch portfolios (backend): ${response.status} - ${errorText}`
    );
    throw new Error(
      `Failed to fetch portfolios from backend: ${response.status}`
    );
  }
...
export const fetchPortfolio = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch portfolio ${id}: ${response.status} - ${errorText}`
    );
...
export const fetchFrontSkills = async (): Promise<ResponseSkills> => {
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch front skills: ${response.status} - ${errorText}`
    );
 ...
 */
export const fetchFrontSkill = async (
  id: string
): Promise<ResponseSkillDetail> => {
  const response = await fetch(
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch front skill ${id}: ${response.status} - ${errorText}`
    );
...
export const fetchBackSkills = async (): Promise<ResponseSkills> => {
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch back skills: ${response.status} - ${errorText}`
    );
 ...
 * @return {ResponseSkillDetail}
 */
export const fetchBackSkill = async (
  id: string
): Promise<ResponseSkillDetail> => {
  const response = await fetch(
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch back skill ${id}: ${response.status} - ${errorText}`
    );
...
export const fetchInfraSkills = async (): Promise<ResponseSkills> => {
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch infra skills: ${response.status} - ${errorText}`
    );
 ...
 * @return {ResponseSkillDetail}
 */
export const fetchInfraSkill = async (
  id: string
): Promise<ResponseSkillDetail> => {
  const response = await fetch(
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch infra skill ${id}: ${response.status} - ${errorText}`
    );
...
export const fetchOtherSkills = async (): Promise<ResponseSkills> => {
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch other skills: ${response.status} - ${errorText}`
    );
 ...
 * @return {ResponseSkillDetail}
 */
export const fetchOtherSkill = async (
  id: string
): Promise<ResponseSkillDetail> => {
  const response = await fetch(
  ...
  if (!response.ok) {
    const errorText = await response.text();
    console.error(
      `Failed to fetch other skill ${id}: ${response.status} - ${errorText}`
    );
